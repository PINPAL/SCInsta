...
NSArray<NSDictionary *> *SPKNotificationPreferenceSections(void) {
    return @[
        @{@"title": @"Action Buttons", @"items": @[
            ...
            SPKNotificationItem(kSPKNotificationDownloadGallery, @"Save to Gallery", @"media"),
            ...
            SPKNotificationItem(kSPKNotificationDownloadAllGallery, @"Save All to Gallery", @"media"),
            ...
            SPKNotificationItem(kSPKNotificationDownloadAudioGallery, @"Save Audio to Gallery", @"media"),
        ...
        @{@"title": @"Media", @"items": @[
            ...
            SPKNotificationItem(kSPKNotificationMediaPreviewSaveGallery, @"Save to Gallery", @"media"),
