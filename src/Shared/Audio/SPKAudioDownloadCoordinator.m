...
static NSURL *SPKAudioURLFromCollectionValue(id collection) {
  ...
  if ([collection isKindOfClass:NSArray.class]) {
    ...
    NSURL *direct = SPKAudioURLFromValue(dict[@"url"] ?: dict[@"src"] ?: dict[@"uri"]);
    if (direct)
      return direct;
  ...
  for (id item in items ?: @[]) {
    ...
    if ([item isKindOfClass:NSDictionary.class]) {
      ...
      url = SPKAudioURLFromValue(dict[@"url"] ?: dict[@"src"] ?: dict[@"uri"]);
    } else {
...
static NSURL *SPKAudioVideoURLFromObject(id object,
  ...
  if ([object isKindOfClass:NSDictionary.class]) {
    NSDictionary *dict = object;
    NSURL *direct = SPKAudioURLFromValue(dict[@"video_url"] ?: dict[@"videoURL"] ?: dict[@"url"]);
    if (direct)
      return direct;
...
static NSURL *SPKAudioBestURLFromObject(id mediaObject,
  ...
  if ([mediaObject isKindOfClass:NSDictionary.class]) {
    ...
    NSURL *direct = SPKAudioURLFromValue(dict[@"audioFileUrl"] ?: dict[@"audioFileURL"] ?: dict[@"playableAudioURL"] ?: dict[@"audioURL"] ?: dict[@"audioUrl"] ?: dict[@"progressiveAudioURL"] ?: dict[@"progressiveAudioUrl"] ?: dict[@"progressiveDownloadURL"] ?: dict[@"progressiveDownloadUrl"]);
    if (direct)
      return direct;
  ...
  void (^runFFmpegFallback)(NSError *) = ^(NSError *avError) {
    ...
    [SPKMediaFFmpeg extractAudioFileURL:sourceURL
        ...
        completion:^(NSURL *_Nullable ffmpegURL,
          ...
          if (completion)
            completion(nil, ffmpegError ?: avError ?: [SPKUtils errorWithDescription:@"Audio conversion failed"]);
        }
        cancelOut:nil];
  };
...
+ (SPKAudioItem *)audioItemFromMediaObject:(id)mediaObject
  ...
  item.title = SPKAudioStringValue(SPKAudioObjectForSelector(mediaObject, @"title") ?: SPKAudioKVCObject(mediaObject, @"title") ?: SPKAudioObjectForSelector(mediaObject, @"displayTitle"));
  item.artist = SPKAudioStringValue(SPKAudioObjectForSelector(mediaObject, @"artistDisplayName") ?: SPKAudioKVCObject(mediaObject, @"artistDisplayName") ?: SPKAudioObjectForSelector(mediaObject, @"username") ?: SPKAudioKVCObject(mediaObject, @"username"));
  item.mediaIdentifier = SPKAudioStringValue(SPKAudioObjectForSelector(mediaObject, @"audioAssetId") ?: SPKAudioKVCObject(mediaObject, @"audioAssetId") ?: SPKAudioObjectForSelector(mediaObject, @"pk") ?: SPKAudioKVCObject(mediaObject, @"pk") ?: SPKAudioObjectForSelector(mediaObject, @"id") ?: SPKAudioKVCObject(mediaObject, @"id"));
