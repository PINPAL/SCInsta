...
SPKImageFormat SPKImageFormatForData(NSData *data) {
    if (data.length < 4) return SPKImageFormatUnknown;
...
SPKImageFormat SPKImageFormatForFileURL(NSURL *fileURL) {
    if (!fileURL.isFileURL) return SPKImageFormatUnknown;
...
NSString *SPKFileExtensionForImageFormat(SPKImageFormat format) {
    switch (format) {
        case SPKImageFormatJPEG: return @"jpg";
        case SPKImageFormatPNG:  return @"png";
        case SPKImageFormatGIF:  return @"gif";
        case SPKImageFormatWebP: return @"webp";
        case SPKImageFormatMP4:  return @"mp4";
        default:                 return nil;
    }
}
...
NSString *SPKMIMETypeForImageFormat(SPKImageFormat format) {
    switch (format) {
        case SPKImageFormatJPEG: return @"image/jpeg";
        case SPKImageFormatPNG:  return @"image/png";
        case SPKImageFormatGIF:  return @"image/gif";
        case SPKImageFormatWebP: return @"image/webp";
        case SPKImageFormatMP4:  return @"video/mp4";
        default:                 return nil;
    }
}
