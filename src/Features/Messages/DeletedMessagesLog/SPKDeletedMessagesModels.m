...
NSString *SPKDeletedMessageKindToString(SPKDeletedMessageKind kind) {
    switch (kind) {
        ...
        case SPKDeletedMessageKindAudioShare: return @"audio_share";
        case SPKDeletedMessageKindReaction: return @"reaction";
        case SPKDeletedMessageKindOther:   return @"other";
...
SPKDeletedMessageKind SPKDeletedMessageKindFromString(NSString *s) {
    if (![s isKindOfClass:[NSString class]]) return SPKDeletedMessageKindUnknown;
    if ([s isEqualToString:@"text"])    return SPKDeletedMessageKindText;
    if ([s isEqualToString:@"photo"])   return SPKDeletedMessageKindPhoto;
    if ([s isEqualToString:@"video"])   return SPKDeletedMessageKindVideo;
    if ([s isEqualToString:@"voice"])   return SPKDeletedMessageKindVoice;
    if ([s isEqualToString:@"gif"])     return SPKDeletedMessageKindGif;
    if ([s isEqualToString:@"sticker"]) return SPKDeletedMessageKindSticker;
    if ([s isEqualToString:@"share"])   return SPKDeletedMessageKindShare;
    if ([s isEqualToString:@"link"])    return SPKDeletedMessageKindLink;
    if ([s isEqualToString:@"audio_share"]) return SPKDeletedMessageKindAudioShare;
    if ([s isEqualToString:@"reaction"]) return SPKDeletedMessageKindReaction;
    if ([s isEqualToString:@"other"])   return SPKDeletedMessageKindOther;
...
NSString *SPKDeletedMessageKindLocalizedName(SPKDeletedMessageKind kind) {
    switch (kind) {
        ...
        case SPKDeletedMessageKindShare:   return @"Share";
        case SPKDeletedMessageKindLink:    return @"Link";
        case SPKDeletedMessageKindAudioShare: return @"Audio";
        case SPKDeletedMessageKindReaction: return @"Reaction";
        case SPKDeletedMessageKindOther:   return @"Other";
        case SPKDeletedMessageKindUnknown:
        default:                           return @"Unknown";
...
NSString *SPKDeletedMessageKindSymbolFilled(SPKDeletedMessageKind kind, BOOL filled) {
    switch (kind) {
        case SPKDeletedMessageKindText:    return @"message";
        case SPKDeletedMessageKindPhoto:   return filled ? @"photo_filled" : @"photo";
        case SPKDeletedMessageKindVideo:   return filled ? @"video_filled" : @"video";
        case SPKDeletedMessageKindVoice:   return filled ? @"voice_filled" : @"voice";
        case SPKDeletedMessageKindGif:     return filled ? @"gif_filled" : @"gif";
        case SPKDeletedMessageKindSticker: return filled ? @"sticker_filled" : @"sticker";
        case SPKDeletedMessageKindShare:   return @"share";
        case SPKDeletedMessageKindLink:    return @"link";
        case SPKDeletedMessageKindAudioShare: return @"audio";
        case SPKDeletedMessageKindReaction: return @"reactions";
        case SPKDeletedMessageKindOther:   return @"message";
        case SPKDeletedMessageKindUnknown:
...
- (NSDictionary *)toJSONDict {
    ...
    if (self.sentAt)               d[@"sent_at"]               = spkDateToJSON(self.sentAt);
    if (self.capturedAt)           d[@"captured_at"]           = spkDateToJSON(self.capturedAt);
    if (self.deletedAt)            d[@"deleted_at"]            = spkDateToJSON(self.deletedAt);
    ...
    if (self.mediaURLStaleAt)      d[@"media_url_stale_at"]    = spkDateToJSON(self.mediaURLStaleAt);
...
- (SPKDeletedMessage *)latest { return self.messages.firstObject; }
