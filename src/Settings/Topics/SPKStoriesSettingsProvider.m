...
static NSDictionary *SPKStoriesSeenReceiptsSection(void) {
    ...
    markSeenOnLike.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"stories_manual_seen"]; };
    markSeenOnReply.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"stories_manual_seen"]; };

    return SPKTopicSection(@"Seen Receipts", @[
        [SPKSetting switchCellWithTitle:@"Manually Mark Seen" icon:SPKSettingsIcon(@"eye") defaultsKey:@"stories_manual_seen"],
        markSeenOnLike,
        markSeenOnReply,
        manualSeenList,
    ], footer);
...
static NSArray *SPKStoriesSettingsSections(void) {
    return @[
        SPKTopicSection(@"Action Button", @[
            [SPKSetting switchCellWithTitle:@"Stories Action Button" icon:SPKSettingsIcon(@"action") defaultsKey:kSPKStoriesActionButtonEnabledKey],
        ...
        SPKTopicSection(@"Story Navigation", @[
            [SPKSetting switchCellWithTitle:@"Stop Auto Advance" icon:SPKSettingsIcon(@"autoscroll") defaultsKey:@"stories_stop_auto_advance"],
            [SPKSetting switchCellWithTitle:@"Advance on Eye Button" icon:SPKSettingsIcon(@"eye") defaultsKey:@"stories_advance_on_manual_seen"],
            [SPKSetting switchCellWithTitle:@"Advance on Story Like" icon:SPKSettingsIcon(@"heart") defaultsKey:@"stories_advance_on_like_seen"],
            [SPKSetting switchCellWithTitle:@"Advance on Story Reply" icon:SPKSettingsIcon(@"reply") defaultsKey:@"stories_advance_on_reply_seen"],
        ...
        SPKTopicSection(@"Confirmations", @[
            [SPKSetting switchCellWithTitle:@"Confirm Like" icon:SPKSettingsIcon(@"heart") defaultsKey:@"stories_confirm_like"],
            [SPKSetting switchCellWithTitle:@"Confirm Quick Reaction" icon:SPKSettingsIcon(@"reactions") defaultsKey:@"stories_confirm_quick_reaction"],
            [SPKSetting switchCellWithTitle:@"Confirm Sticker Interaction" icon:SPKSettingsIcon(@"sticker") defaultsKey:@"stories_confirm_sticker"]
