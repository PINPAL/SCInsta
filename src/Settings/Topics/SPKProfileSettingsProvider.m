...
+ (SPKSetting *)rootSetting {
    return SPKTopicNavigationSetting(@"Profile", @"user_circle", 24.0, @[
        SPKTopicSection(@"Action Button", @[
            [SPKSetting switchCellWithTitle:@"Profile Action Button" icon:SPKSettingsIcon(@"action") defaultsKey:@"profile_action_btn"],
        ...
        SPKTopicSection(@"Profile Picture", @[
            [SPKSetting switchCellWithTitle:@"Long Press to Expand" icon:SPKSettingsIcon(@"expand") defaultsKey:@"profile_photo_zoom"]
        ], @"Long press a profile picture to open it expanded."),
        SPKTopicSection(@"Indicators", @[
            [SPKSetting switchCellWithTitle:@"Show Following Indicator" icon:SPKSettingsIcon(@"user_check") defaultsKey:@"profile_follow_indicator"],
            [SPKSetting switchCellWithTitle:@"Hide Notes Bubble" icon:SPKSettingsIcon(@"notes") defaultsKey:@"profile_hide_notes_bubble"],
            [SPKSetting switchCellWithTitle:@"Hide Threads Button" icon:SPKSettingsIcon(@"threads") defaultsKey:@"profile_hide_threads_btn"]
        ], nil),
        SPKTopicSection(@"Confirmation", @[
            [SPKSetting switchCellWithTitle:@"Confirm Follow" icon:SPKSettingsIcon(@"user_follow") defaultsKey:@"profile_confirm_follow"],
            [SPKSetting switchCellWithTitle:@"Confirm Unfollow" icon:SPKSettingsIcon(@"user_unfollow") defaultsKey:@"profile_confirm_unfollow"]
