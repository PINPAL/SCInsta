...
static NSArray *SPKInstantsSettingsSections(void) {
    return @[
        SPKTopicSection(@"Action Button", @[
            [SPKSetting switchCellWithTitle:@"Instants Action Button" icon:SPKSettingsIcon(@"action") defaultsKey:kSPKInstantsActionButtonEnabledKey],
        ...
        SPKTopicSection(@"Privacy", @[
            [SPKSetting switchCellWithTitle:@"Allow Screenshots" icon:SPKSettingsIcon(@"warning") defaultsKey:@"instants_allow_screenshot"],
        ...
        SPKTopicSection(@"Creation", @[
            ...
            [SPKSetting switchCellWithTitle:@"Skip Camera After Instants" icon:SPKSettingsIcon(@"camera") defaultsKey:@"instants_skip_camera_after_viewing"],
            ...
            [SPKSetting switchCellWithTitle:@"Upload from Gallery" icon:SPKSettingsIcon(@"photo_gallery") defaultsKey:@"instants_upload_from_gallery"],
        ...
        SPKTopicSection(@"Confirmation", @[
            ...
            [SPKSetting switchCellWithTitle:@"Confirm Instant Reaction" icon:SPKSettingsIcon(@"reactions") defaultsKey:@"instants_confirm_reaction"],
