...
+ (SPKSetting *)rootSetting {
    ...
    return SPKTopicNavigationSetting(@"General", @"settings", 24.0, @[
        SPKTopicSection(@"Behavior", @[
            [SPKSetting switchCellWithTitle:@"Copy Text" icon:SPKSettingsIcon(@"text") defaultsKey:@"general_copy_text"],
            [SPKSetting switchCellWithTitle:@"No Recent Searches" icon:SPKSettingsIcon(@"search") defaultsKey:@"general_no_recent_searches"],
            [SPKSetting switchCellWithTitle:@"Copy Links Without Tracking" icon:SPKSettingsIcon(@"user_unfollow") defaultsKey:@"general_strip_share_link_tracking"],
            [SPKSetting switchCellWithTitle:@"Hold Send to Copy Link" icon:SPKSettingsIcon(@"link") defaultsKey:@"general_hold_send_copy_link"],
        ...
        SPKTopicSection(@"Recommendations", @[
            [SPKSetting navigationCellWithTitle:@"Ads"
                                    ...
                                    navSections:@[
                SPKTopicSection(@"Ads", @[
                    [SPKSetting switchCellWithTitle:@"Hide Feed Ads" defaultsKey:@"general_hide_ads_feed"],
                    [SPKSetting switchCellWithTitle:@"Hide Story Ads" defaultsKey:@"general_hide_ads_stories"],
                    [SPKSetting switchCellWithTitle:@"Hide Reels Ads" defaultsKey:@"general_hide_ads_reels"],
                    [SPKSetting switchCellWithTitle:@"Hide Explore Ads" defaultsKey:@"general_hide_ads_explore"],
                    [SPKSetting switchCellWithTitle:@"Hide Reels Shopping CTA" defaultsKey:@"general_hide_reels_shopping_cta"]
                ], nil)
            ]],
            [SPKSetting navigationCellWithTitle:@"Meta AI"
                                    ...
                                    navSections:@[
                SPKTopicSection(@"", @[
                    [SPKSetting switchCellWithTitle:@"Hide in Direct" defaultsKey:@"general_hide_meta_ai_msgs"],
                    [SPKSetting switchCellWithTitle:@"Hide in Explore & Search" defaultsKey:@"general_hide_meta_ai_explore"],
                    [SPKSetting switchCellWithTitle:@"Hide in Comments" defaultsKey:@"general_hide_meta_ai_comments"],
                    [SPKSetting switchCellWithTitle:@"Hide in Creation Tools" defaultsKey:@"general_hide_meta_ai_creation"],
                    [SPKSetting switchCellWithTitle:@"Hide Global AI Chrome" defaultsKey:@"general_hide_meta_ai_global"]
            ...
            [SPKSetting navigationCellWithTitle:@"Suggested Users"
                ...
                SPKTopicSection(@"Suggested Users", @[
                    [SPKSetting switchCellWithTitle:@"Hide Feed Suggestions" defaultsKey:@"general_hide_suggested_users_feed"],
                    [SPKSetting switchCellWithTitle:@"Hide Reels Suggestions" defaultsKey:@"general_hide_suggested_users_reels"],
                    [SPKSetting switchCellWithTitle:@"Hide Direct Suggestions" defaultsKey:@"general_hide_suggested_users_msgs"],
                    [SPKSetting switchCellWithTitle:@"Hide Search Suggestions" defaultsKey:@"general_hide_suggested_users_search"],
                    [SPKSetting switchCellWithTitle:@"Hide Profile Suggestions" defaultsKey:@"general_hide_suggested_users_profile"],
                    [SPKSetting switchCellWithTitle:@"Hide Activity Suggestions" defaultsKey:@"general_hide_suggested_users_activity"],
                    [SPKSetting switchCellWithTitle:@"Hide Follow-List Suggestions" defaultsKey:@"general_hide_suggested_users_follow_lists"],
                    [SPKSetting switchCellWithTitle:@"Hide Subscription Suggestions" defaultsKey:@"general_hide_suggested_users_subscriptions"]
                ], nil)
            ]]
        ], @"Control ads, AI and suggestions visibility by surface."),
        SPKTopicSection(@"Comments", @[
            [SPKSetting switchCellWithTitle:@"Copy Comment" icon:SPKSettingsIcon(@"copy") defaultsKey:@"general_comments_copy_text"],
            [SPKSetting switchCellWithTitle:@"Comment Media Actions" icon:SPKSettingsIcon(@"action") defaultsKey:@"general_comments_media_actions"],
            [SPKSetting switchCellWithTitle:@"Upload Photo from Gallery" icon:SPKSettingsIcon(@"photo") defaultsKey:@"general_comments_gallery_upload"]
        ...
        SPKTopicSection(@"", @[
            [SPKSetting switchCellWithTitle:@"Swipe to Close Comments" icon:SPKSettingsIcon(@"left_right") defaultsKey:@"general_comments_swipe_close"],
        ...
        SPKTopicSection(@"", @[
            [SPKSetting switchCellWithTitle:@"Confirm Comment Like" icon:SPKSettingsIcon(@"heart") defaultsKey:@"general_comments_confirm_like"],
            [SPKSetting switchCellWithTitle:@"Hide Comment Shopping" icon:SPKSettingsIcon(@"shopping_bag") defaultsKey:@"general_comments_hide_shopping"],
            [SPKSetting switchCellWithTitle:@"Hide Gifts Button" icon:SPKSettingsIcon(@"gift") defaultsKey:@"general_comments_hide_gifts_button"],
        ...
        SPKTopicSection(@"Storage", @[
            clearCacheSetting,
            [SPKSetting menuCellWithTitle:@"Auto Clear Cache" icon:SPKSettingsIcon(@"clock") menu:SPKCacheAutoClearMenu()]
