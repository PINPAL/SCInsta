...
static NSArray *SPKMessagesSettingsSections(void) {
    ...
    seenOnSend.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"msgs_manual_seen"]; };
    seenOnReply.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"msgs_manual_seen"]; };
    seenOnReaction.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"msgs_manual_seen"]; };
    ...
    advanceVisual.enabledProvider = ^BOOL{ return [SPKUtils getBoolPref:@"msgs_manual_visual_seen"]; };

    return @[
        SPKTopicSection(@"Action Button", @[
            [SPKSetting switchCellWithTitle:@"Messages Action Button" icon:SPKSettingsIcon(@"action") defaultsKey:kSPKMessagesActionButtonEnabledKey],
        ...
        SPKTopicSection(@"Messaging", @[
            [SPKSetting switchCellWithTitle:@"Manually Mark Seen" icon:SPKSettingsIcon(@"eye") defaultsKey:@"msgs_manual_seen"],
            seenOnSend,
            seenOnReply,
            seenOnReaction,
            manualSeenList,
        ...
        SPKTopicSection(@"Deleted Messages", @[
            [SPKSetting switchCellWithTitle:@"Keep Deleted Messages" icon:SPKSettingsIcon(@"undo_circle") defaultsKey:@"msgs_keep_deleted"],
            [SPKSetting switchCellWithTitle:@"Confirm Inbox Refresh" icon:SPKSettingsIcon(@"arrow_cw") defaultsKey:@"msgs_confirm_refresh"],
            [SPKSetting switchCellWithTitle:@"Log Deleted Messages" icon:SPKSettingsIcon(@"logs") defaultsKey:@"msgs_deleted_log"],
            [SPKSetting switchCellWithTitle:@"Log Removed Reactions" icon:SPKSettingsIcon(@"reactions") defaultsKey:@"msgs_deleted_log_reactions"],
            [SPKSetting switchCellWithTitle:@"Respect Seen Chat List" icon:SPKSettingsIcon(@"eye") defaultsKey:@"msgs_deleted_log_respect_seen_list"],
        ...
        SPKTopicSection(@"Interface", @[
            [SPKSetting switchCellWithTitle:@"Hide Typing Status" icon:SPKSettingsIcon(@"keyboard") defaultsKey:@"msgs_disable_typing"],
            [SPKSetting switchCellWithTitle:@"Hide Reels Blend Button" icon:SPKSettingsIcon(@"blend") defaultsKey:@"msgs_hide_reels_blend"],
            [SPKSetting switchCellWithTitle:@"Hide Audio Call Button" icon:SPKSettingsIcon(@"call") defaultsKey:@"msgs_hide_audio_call_btn"],
            [SPKSetting switchCellWithTitle:@"Hide Video Call Button" icon:SPKSettingsIcon(@"video") defaultsKey:@"msgs_hide_video_call_btn"],
            [SPKSetting switchCellWithTitle:@"No Suggested Chats" icon:SPKSettingsIcon(@"question") defaultsKey:@"msgs_hide_suggested_chats"],
        ...
        SPKTopicSection(@"Confirmation", @[
            [SPKSetting switchCellWithTitle:@"Confirm Audio Call" icon:SPKSettingsIcon(@"call") defaultsKey:kSPKMessagesAudioCallConfirmKey],
            [SPKSetting switchCellWithTitle:@"Confirm Video Call" icon:SPKSettingsIcon(@"video") defaultsKey:kSPKMessagesVideoCallConfirmKey],
            [SPKSetting switchCellWithTitle:@"Confirm Double Tap" icon:SPKSettingsIcon(@"heart") defaultsKey:@"msgs_confirm_double_tap"],
            [SPKSetting switchCellWithTitle:@"Confirm Reactions" icon:SPKSettingsIcon(@"reactions") defaultsKey:@"msgs_confirm_reaction"],
            [SPKSetting switchCellWithTitle:@"Confirm Voice Messages" icon:SPKSettingsIcon(@"voice") defaultsKey:@"msgs_confirm_voice_msg"],
            [SPKSetting switchCellWithTitle:@"Confirm Follow Requests" icon:SPKSettingsIcon(@"user_request") defaultsKey:@"msgs_confirm_follow_request"],
            [SPKSetting switchCellWithTitle:@"Confirm Vanish Mode" icon:SPKSettingsIcon(@"vanish") defaultsKey:@"msgs_confirm_vanish_mode"],
            [SPKSetting switchCellWithTitle:@"Confirm Changing Theme" icon:SPKSettingsIcon(@"palette") defaultsKey:@"msgs_confirm_theme_change"]
