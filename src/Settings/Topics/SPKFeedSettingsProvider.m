...
+ (SPKSetting *)rootSetting {
    return SPKTopicNavigationSetting(@"Feed", @"feed", 24.0, @[
        SPKTopicSection(@"Action Button", @[
            [SPKSetting switchCellWithTitle:@"Feed Action Button" icon:SPKSettingsIcon(@"action") defaultsKey:kSPKFeedActionButtonEnabledKey],
        ...
        SPKTopicSection(@"Metrics", @[
            ...
            [SPKSetting switchCellWithTitle:@"Hide Repost Count" icon:SPKSettingsIcon(@"repost") defaultsKey:@"feed_hide_repost_count"],
            [SPKSetting switchCellWithTitle:@"Hide Reshare Count" icon:SPKSettingsIcon(@"messages") defaultsKey:@"feed_hide_reshare_count"]
        ], nil),
        SPKTopicSection(@"Media", @[
            [SPKSetting switchCellWithTitle:@"Long Press to Expand" icon:SPKSettingsIcon(@"expand") defaultsKey:@"feed_long_press_expand"],
            [SPKSetting switchCellWithTitle:@"Disable Video Autoplay" icon:SPKSettingsIcon(@"autoplay_off") defaultsKey:@"feed_disable_autoplay" requiresRestart:YES],
            [SPKSetting switchCellWithTitle:@"Start Expanded Videos Muted" icon:SPKSettingsIcon(@"volume_off") defaultsKey:@"feed_expanded_vid_start_muted"],
        ...
        SPKTopicSection(@"Refresh", @[
            [SPKSetting switchCellWithTitle:@"Disable Home Tab Refresh" icon:SPKSettingsIcon(@"home") defaultsKey:@"feed_disable_home_refresh"],
            [SPKSetting switchCellWithTitle:@"Disable Background Refresh" icon:SPKSettingsIcon(@"arrow_cw") defaultsKey:@"feed_disable_bg_refresh"]
